#include "Test/TestDeferredRendering.h"
...
namespace test
{
	...
	void TestDeferredRendering::onUpdate(float deltaTime, const Input& hardwareInput)
	{
		// 处理硬件输入
	...
	{
		ImGui::SeparatorText("Render Target##TestDeferredRendering");
		if (ImGui::Button("Add Model##TestDeferredRendering"))
		{
			IGFD::FileDialogConfig config;
			config.path = std::string(PROJ_RES_PATH) + "/Models";
			ImGuiFileDialog::Instance()->OpenDialog("Choose A Model File##TestDeferredRendering", "Please select model file", ".*", config);
		}
		if (ImGuiFileDialog::Instance()->Display("Choose A Model File##TestDeferredRendering")) {
		...
		ImGui::Begin("Objects##TestDeferredRendering");
		...
		ImGui::Begin("Lights##TestDeferredRendering");
		...
		ImGui::Begin("Position Texture##TestDeferredRendering");
		...
		ImGui::Begin("Normal Texture##TestDeferredRendering");
		...
		ImGui::Begin("Albedo Texture##TestDeferredRendering");
		...
		ImGui::Begin("Specular Texture##TestDeferredRendering");
	...
	void TestDeferredRendering::processInput(const Input& hardware_input, float deltaTime) const
	{
		// 鼠标
